    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(
                    blank=True, max_length=20, null=True, region='DE')),
                ...
                ('role', models.CharField(choices=[('landowner', 'Landowner'), (
                    'developer', 'Project Developer')], default='landowner', max_length=20)),
                ('reset_code', models.CharField(
                    blank=True, max_length=6, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iso3166', models.CharField(max_length=5, null=True,
        ...
        migrations.CreateModel(
            name='Landowner',
            fields=[
                ('marketuser_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interest', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='accounts.projectdeveloperinterest')),
